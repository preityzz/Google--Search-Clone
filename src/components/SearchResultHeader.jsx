...
const SearchResultHeader = () => {
    ...
    return (
    <div className="p-[15px] pb-0 md:pr-5 md:pl-20 md:pt-7 border-b border-[#ebebeb]
    flex md:block flex-col items-center sticky top-0 bg-white">
            ...
            {menu.map((menu,index) => (
                ...
                >
                    ...
                    {selectedMenu ===menu.name &&(
                        <span className="h-[3px] w-[calc(100%-20px)] absolute bg-[#1a73e8] 
                        bottom-0 left-[10px]"/>
                    )}
                </span>
            ))}
